  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#060a08] flex flex-col">
      ...
      <div className="bg-white dark:bg-[#0b120e] border-b border-slate-100 dark:border-[#162218] px-5 pb-6" style={{ paddingTop: "max(56px, env(safe-area-inset-top, 56px))" }}>
        ...
        {org?.type && (
          <span className="inline-block mt-2 text-[11px] font-semibold rounded-full px-2.5 py-0.5 border text-[#3DA829] border-[#3DA829] bg-[rgba(0,166,81,0.08)]">
      ...
      <div className="flex-1 px-5 pt-8 pb-10 space-y-5">
        ...
        <div className="bg-slate-50 dark:bg-[#0b120e] border border-slate-100 dark:border-[#162218] rounded-xl px-4 py-3 space-y-1.5">
          ...
          {[
            ...
            <div key={rule} className="flex items-center gap-2">
              <div className={`w-3.5 h-3.5 rounded-full flex items-center justify-center flex-shrink-0 ${pass ? "bg-[#3DA829]" : "bg-slate-200 dark:bg-slate-700"}`}>
              ...
              <p className={`text-[11px] font-medium ${pass ? "text-[#3DA829]" : "text-slate-400 dark:text-slate-500"}`}>
                {rule}
              </p>
            </div>
          ))}
        ...
        <button
          ...
          className="w-full text-white font-bold rounded-2xl py-4 text-sm transition disabled:opacity-50 bg-[#3DA829]"
        >
