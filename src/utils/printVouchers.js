...
// Each row unit = card (15mm) + 1mm gap + ~3mm sub-footer text space + 1mm before next = 20mm.
const ROW_STEP = 20;
...
// Rows per page: (297 - 20mm margins) / 20mm per row = 13 rows × 4 cols = 52 cards.
...
async function buildVoucherPdf(pins, businessName) {
  ...
  pins.forEach((pin, idx) => {
    ...
    // Sub-footer: branding line centred on the card, 1 mm below the card border
    doc.setFontSize(3);
    doc.setFont('helvetica', 'normal');
    doc.setTextColor(160, 160, 160);
    doc.text(CARD_FOOTER, x + CARD_W / 2, y + CARD_H + 1, {
