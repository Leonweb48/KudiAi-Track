-- D8: Shift / attendance tracking (idempotent)
...
DROP POLICY IF EXISTS "owner_manage_shifts"         ON public.staff_shifts;
DROP POLICY IF EXISTS "staff_manage_own_shifts"     ON public.staff_shifts;
